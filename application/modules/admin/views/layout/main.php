                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        <!-- <li class="nav-item dropdown no-arrow mx-1">
                            <a class="nav-link text-primary" href="<? //= site_url('admin/manajemenuser/index') 
                                                                    ?>"
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="<?= site_url('admin/profil/index') ?>">
                                    <i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>
                                    Profil
                                </a>
                                <a class="dropdown-item" href="<?= site_url('admin/gantipassword/index') ?>">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; 2020, Version 1.0-<?= $this->config->item('namatoko'); ?></span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
