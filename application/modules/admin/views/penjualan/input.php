<script type="text/javascript" src="<?php echo base_url('assets/js/inputpenjualan.js') ?>"></script>
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">
                    <button type="button" class="btn btn-primary" id="btndatapenjualan">
                        <i class="fa fa-fw fa-tasks"></i> Data Semua Penjualan
                    </button>
                </h6>
            </div>
            <div class="card-body">
