...
<div class="modal fade bd-example-modal-lg" id="modaltambahdata" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <?php echo form_open('admin/produk/simpandata', array('class' => 'formtambah')) ?>
            <div class="modal-body">
                <div class="pesan" style="display: none;"></div>
                <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Kode Produk/Barcode</label>
                    <div class="col-sm-9">
                ...
                <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Isikan Harga Jual (Rp.)</label>
                    <div class="col-sm-4">
                        <input type="text" class="form-control" name="harga" id="harga" style="text-align: right;">
                        <input type="hidden" name="hargax" id="hargax">
                    </div>
                </div>
            </div>
