<?php
class Modelstokmasukx extends CI_Model
{
    // var $table = 'kategori'; //nama tabel dari database
    var $column_order = array(null, 'produkkode', 'produknm', 'produkharga', 'satnama', null);
    ...
    private function _get_datatables_query_produk()
    {
        ...
        $this->db->select('produkid,produkkode,produknm,produkharga,satnama')
            ->from('produk')
